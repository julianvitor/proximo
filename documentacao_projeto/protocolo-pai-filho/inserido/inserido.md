...
- **Formato**: `inserido:UID`
- **Exemplo**: `inserido:1A2B3C4D`

**Características**:

- A string começa com a palavra "inserido:".
- Segue o UID do cartão RFID. Recomenda-se o uso de formato hexadecimal para padronização.
- Enviado para todos os clientes conectados via WebSocket quando um novo cartão RFID é detectado.

## Descrição dos Campos

### inserido

- **inserido:** (prefixo) Indica que um novo cartão RFID foi detectado e inserido.
