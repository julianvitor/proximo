// Definição das frequências das notas musicais (em Hertz)
#define NOTE_B0  31
#define NOTE_C1  33
#define NOTE_CS1 35
#define NOTE_D1  37
...
// Duração de cada nota (unidade de tempo)
int noteDurations[] = {
...
void setup() {
  ...
  // Tocar cada nota na melodia
  for (int i = 0; i < 18; i++) {
    int noteDuration = noteDurations[i];
     tone(buzzerPin, melody[i], noteDuration);
    delay(noteDuration * 1.3);  // Atraso entre as notas
  }
}
